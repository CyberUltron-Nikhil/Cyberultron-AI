...
- used scapy to build a custom network packet capture tool that convert raw packet data into the expected input format for the model [image](progress\till_17_04_2025\image.png)
